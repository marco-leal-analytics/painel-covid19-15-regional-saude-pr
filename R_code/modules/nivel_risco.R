...
nivel_risco <<- tabPanel(title = tags$div(HTML('<i class="fa fa-thermometer-three-quarters"style = "color:#0072B2;font-size:30px"></i>')),
                         
                         fluidRow(
                           box(title= tags$div(HTML('<i class="fa fa-thermometer-three-quarters"style = "color:#0072B2;font-size:50px"></i>
                             ...
                             mainPanel(
                               ...
                               tabBox(width = "700px",
                                      ...
                                      tabPanel("Risco estimado do aumento de casos",
                                               ...
                                               bsModal("modalExample", "No vídeo abaixo apresentamos uma análise 
                                               do nível de risco.", "Id113", size = "large",uiOutput("video")),
                                               plotlyOutput("rankrisco")),
                                      
                                      tabPanel("Risco estimado do aumento de casos relativo ao tamanho da população", plotlyOutput("rankriscorelativo")))
                             )))
)

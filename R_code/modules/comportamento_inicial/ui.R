...
comportamento_inicialUI <- function(id) {
  ...
  fluidRow(box_card( title= tags$div(HTML('<i class="fas fa-chart-line" style = "color:#0072B2;font-size:50px"></i>
  <b style = "padding-left:25px;color:#000000;font-size:30px">
                ...
                tags$head(tags$style(HTML("hr {border-top: 5px solid;}"))), width = 12)),
                                        ...
                                        sidebarLayout(
                                          sidebarPanel(
                                            box_card(width="200px", background = "light-blue",titlePanel("Escolha uma cidade"),
                                          ...
                                          mainPanel(
                                            ...
                                            tabPanel(title = tags$div(HTML('<i class="fa fa-chart-line"style = "color:#0072B2;font-size:30px"></i>')),
                                                     fluidRow(box_card( title= tags$div(HTML('<i class="fas fa-chart-line" style = "color:#0072B2;font-size:50px"></i>
                                                                   ...
                                                                   tags$head(tags$style(HTML("hr {border-top: 5px solid;}"))), width = 12)),
                                                     id = ns("tabset1"), height = "500px", width = "700px",
                                            ...
                                            tabBox( title = "São considerados 2 infectados e 3 expostos no início",
                                                    id = ns("tabset1"), height = "500px", width="700px",
                                                    tabPanel("15 dias", plotlyOutput(ns("atraso15"))),
                                                    tabPanel("30 dias", plotlyOutput(ns("atraso30"))),
                                                    tabPanel("45 dias", plotlyOutput(ns("atraso45"))),
                                                    tabPanel("60 dias", plotlyOutput(ns("atraso60"))))),
                                            tabPanel(tags$div(HTML('<i class="fa fa-chart-line"style = "color:#000000;font-size:30px"></i>')),
                                                     fluidRow(box_card( title= tags$div(HTML('<i class="fas fa-chart-line" style = "color:#000000;font-size:50px"></i>
                   ...
                   tabBox(title = "São considerados 0 infectados e 0 expostos no início",
                          id = ns("tabset1"), height = "500px", width="700px",
                          tabPanel("1 exposto por dia", plotlyOutput(ns("espostos1"))),
                          tabPanel("3 expostos por dia", plotlyOutput(ns("espostos3"))),
                          tabPanel("5 expostos por dia", plotlyOutput(ns("espostos5"))),
                          tabPanel("10 expostos por dia", plotlyOutput(ns("espostos10")))))

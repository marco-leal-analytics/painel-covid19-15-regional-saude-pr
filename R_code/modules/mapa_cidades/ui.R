...
mapa_cidades_panelUI <- function(id) {
  ...
  numero_reproducao <- tabPanel(title =tags$div(HTML('<i class="fa fa-prescription"style = "color:#0072B2;font-size:20px"></i>')),
                                ...
                                fluidRow(column(width=12,valueBoxOutput(ns("rzero")))),
                                fluidRow(
  ...
  fluidRow(
    fluidRow(column(width=12,align="center",div(style="text-size:50px;",strong(textOutput(ns("painel_text")))))),
    tags$div(style= "padding-left:50px", tabsetPanel(id = ns("tabset"),type = "tabs",
                ...
                div( plotlyOutput(ns("plot_gcidades")))
                ),
                ...
                plotlyOutput(ns("plot_por_dia_municipio"))),
                ...
                fluidRow(column(width=12,align="left",tags$div(HTML('<i class="fa fa-exclamation-triangle"style = "color:#0072B2;font-size:50px"></i>
                                                                    <b style = "padding-left:25px;color:#000000;font-size:30px">
                                                                    INCIDÊNCIA </b>')))),
                plotlyOutput(ns("plot_incidencia_municipios"))),
                ...
                fluidRow(column(width=12,align="left",tags$div(HTML('<i class="fa fa-users"style = "color:#0072B2;font-size:50px"></i>
                                                                    <b style = "padding-left:25px;color:#000000;font-size:30px">
                                                                    FAIXA ETÁRIA </b>')))),
                plotlyOutput(ns("plot_por_faixaetaria_municipio"))),
                tabPanel( title = tags$div(HTML('<i class="fa fa-venus-mars"style = "color:#0072B2;font-size:20px"></i>')),
                          div(uiOutput(ns("plot_sexo_municipio")),style="padding-left:20px;")),
                numero_reproducao,
                taxa_propagacao,
                evolucao_n_infec
                ))
...
mapa_cidadesUI <- function(id) {
  ...
  tabPanel(title = tags$div(HTML('<i class="fa fa-map-marked-alt"style = "color:#0072B2;font-size:30px"></i>')),

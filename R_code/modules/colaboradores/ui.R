...
colaboradoresUI <- function(id) {
  ...
  tabPanel(value = 'col',title = tags$div(HTML('<i class="fa fa-users"style = "color:#0072B2;font-size:30px"></i>')),
                             fluidRow(
                               box_card(title= tags$div(HTML('<i class="fa fa-users"style = "color:#0072B2;font-size:50px"></i>
                               ...
                               column(4,
                                      box_card(title= tags$div(HTML('<i class="fa fa-id-card"style = "color:#0072B2;font-size:50px"></i>
